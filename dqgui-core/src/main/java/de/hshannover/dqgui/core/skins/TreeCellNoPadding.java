...
package de.hshannover.dqgui.core.skins;
...
public class TreeCellNoPadding<T> extends TreeCellSkin<T> {
    @SuppressWarnings("unchecked")
    public TreeCellNoPadding(@SuppressWarnings("rawtypes") TreeCell control) {
        super(control);
    }
